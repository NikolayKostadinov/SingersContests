...
(function () {
    ...
    function removeCategoryButtonClick(event) {
        ...
        document.querySelector('[name="category-row"][data-index = "' + index + '"]').hidden = true;
    }
    ...
    function createCategoryElement(index) {
        let html = "<div class=\"row align-middle\" name=\"category-row\" data-index=\"" + index + "\">\n" +
            ...
            "                <div class=\"col-1\">\n" +
            "                    <button id=\"performanceCategories" + index + ".deleted\"  type=\"button\" class=\"btn-close\" name=\"remove-category\" data-id='" + index + "'></button>\n" +
            "                </div>\n" +
            "            </div>";
